...
<audio controls><source src="./files/hack_your_data_podcast_2.mp3" type="audio/mpeg"></audio>

### Schedule

#### Monday, the 15th of April (first day)

9.45 - Thinking like a computer (Carolyn Saund)  
...
9.45 - Coding and reproducible workflows (Professor Lisa DeBruine)  
...
9.45 - Your data and visualizations (Lovisa Sundin)  

### Install R & R Studio

You can install R in advance by following [instructions for Installing R on Your own Machine](r_instructions.html)
...
```{r, out.width="100%", fig.width=9, fig.height=4.5, message=FALSE, warning = FALSE}
...
More information at [Scottish Graduate School of Social Science](https://www.sgsss.ac.uk/training/spring-into-methods/).
