...
In the previous sessions, we have already had some practice with `ggplot2` and with `tidytext`. Now we are going to learn how to scrape data from Twitter with the `rtweet` package and use this in conjunction with our new text wrangling skills. All that is needed is a Twitter account, and we are good to go. Along with this tutorial, you can also refer back to the [slides](files/rtweet/rtweet_2019_AH.pdf) for this session.
