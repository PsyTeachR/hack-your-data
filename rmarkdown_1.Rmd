...
<img src="img/rmarkdown.png" align="right" width=150 style="margin:10px 20px"></img>
...
There are some extras on the slides for this session to proide you with a little more information going forward.
